...
public class HealerUnit : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        thisUnit = GameObject.Find("Healer");
    }
    ...
    void Update()
    {
        ...
        if (TacticalManager.takeAct == ActState.MOVE && TacticalManager.selected == thisUnit && !anim.GetCurrentAnimatorStateInfo(0).IsName("Tactics_TempPriest3_Attack"))
        {
        ...
        if (TacticalManager.takeAct == ActState.ATTACK && TacticalManager.selected == thisUnit && !anim.GetCurrentAnimatorStateInfo(0).IsName("Tactics_TempPriest3_Attack"))
        {
            anim.SetBool("isWalking", false);
